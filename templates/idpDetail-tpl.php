...
if (!is_null($idpName) && !empty($idpName)) {
    ...
    $this->data['header'] = $this->t('{proxystatistics:Proxystatistics:templates/idpDetail_header_entityId}') . $idpEntityId;
}
...
?>
    <script type="text/javascript">
        ...
        function drawAccessedSpsTable() {
            ...
            data.addRows([<?php DatabaseCommand::getAccessCountForIdentityProviderPerServiceProviders($lastDays, $idpEntityId)?>]);
